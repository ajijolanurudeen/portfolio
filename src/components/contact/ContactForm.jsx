...
export default function ContactForm() {
    ...
    return (
        //form submit action and things of that nature
        <form action="https://formsubmit.co/ajijolanurudeen@gmail.com" method="POST" className='max-w-[753px] mx-auto '>
            ...
            <button type="submit" className="block bg-green py-[12px] px-[27px] text-sm mt-6 mx-auto hover:bg-transparent hover:border-white border border-transparent cursor-pointer transition-all">
                Submit now
            </button>
        </form>
